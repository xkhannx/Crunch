...
public class LevelSelector : MonoBehaviour
{
    ...
    public void OpenLevelOptions(int buttonId)
    {
        ...
        else 
        {
            ...
            else
            {
                ...
                MapData tempMap = SaveSystem.Load(Application.persistentDataPath + "/maps/" + mapNames[currentLevelID]);
                if (tempMap != null)
                {
                    if (!tempMap.playable)
                    {
    ...
    public void EditLevel(bool newLevel)
    {
        ...
        if (newLevel)
        {
            newPath = Application.persistentDataPath + "/maps/" + renameWindow.GetComponentInChildren<InputField>().text;
        } else
        {
            newPath = Application.persistentDataPath + "/maps/" + levels[currentLevelID].GetComponentInChildren<Text>().text;
        }
        FindObjectOfType<CurrentLevel>().levelToLoad = newPath;
    ...
    public void PlayLevel()
    {
        ...
        FindObjectOfType<CurrentLevel>().levelToLoad = Application.persistentDataPath + "/maps/" + levels[currentLevelID].GetComponentInChildren<Text>().text;
